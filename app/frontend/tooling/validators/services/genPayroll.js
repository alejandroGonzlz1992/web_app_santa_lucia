...
/* Payroll Generate Validator Class */
export class GeneratePayrollValidator {

    /* constructor */
    constructor(idForm) {
        this.form = document.getElementById(idForm);
        this.valid = true;
        this.data = Static.PAYROLL_GENERATE_FORM_DICT;
    ...
    initEventValidators() {
        ...
        /* on-time validators */
        this.payrollPeriodSelectFieldValidate("payroll_period");
    ...
    validateBlankFields() {
        ...
        Static.PAYROLL_GENERATE_BLANK_FIELDS.forEach((item) => {
            /* current div element */
    ...
    payrollPeriodSelectFieldValidate(fieldName) {
        /* get input element and div ids */
        let inputField = this.form.elements.namedItem(fieldName);
        let divStatus = document.getElementById(this.data.payroll_period.div_id.status);

        /* validate on-time blank fields */
        Shared.validateInputBlankFields(inputField, divStatus, this.data.payroll_period.text.status, this);
        ...
        if(this.valid){
            ...
            inputField.addEventListener("input", () => {
                ...
                if(value === "not_select"){
                    ...
                    /* display error message */
                    Shared.displayErrorMessages(inputField, divStatus, this.data.payroll_period.text.status);
                    /* update flag */
                    this.valid = false;
                }
                else {
