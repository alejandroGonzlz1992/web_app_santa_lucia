...
export class DepartmentValidator {
    ...
    constructor(idForm) {
        ...
        this.valid = true;
        this.data = Static.DEPARTMENTS_FORM_DICT;
    ...
    initEventValidators() {
        /* on-time validators */
        this.departmentNameFieldValidate('department_name');

        this.departmentStatusFieldValidate('department_status');

        this.departmentCreateDateFieldValidate('department_create_date');
    ...
    validateBlankFields() {
        ...
        Static.DEPARTMENTS_BLANK_FIELDS.forEach((item) => {
    ...
    departmentNameFieldValidate(fieldName) {
        /* get input element and div ids */
        let inputField = this.form.elements.namedItem(fieldName);
        let divBlank = document.getElementById(this.data.department_name.div_id.blank);
        let divChars = document.getElementById(this.data.department_name.div_id.chars);
        let divLength = document.getElementById(this.data.department_name.div_id.length);

        /* validate on-time blank fields */
        Shared.validateInputBlankFields(inputField, divBlank, this.data.department_name.text.blank, this);
        ...
        if(this.valid){
            ...
            inputField.addEventListener("input", () => {
                ...
                if(!Static.REGEX.only_letters.test(value)){
                    ...
                    /* display error message */
                    Shared.displayErrorMessages(inputField, divChars, this.data.department_name.text.chars);
                    /* update flag */
                    this.valid = false;
                }
                    ...
                    /* display error message */
                    Shared.displayErrorMessages(inputField, divLength, this.data.department_name.text.length);
                    /* update flag */
                    this.valid = false;
                }
                else {
    ...
    departmentStatusFieldValidate(fieldName){
        /* get input element and div ids */
        let inputField = this.form.elements.namedItem(fieldName);
        let divStatus = document.getElementById(this.data.department_status.div_id.status);

        /* validate on-time blank fields */
        Shared.validateInputBlankFields(inputField, divStatus, this.data.department_status.text.status, this);
        ...
        if(this.valid){
            ...
            inputField.addEventListener("input", () => {
                ...
                if(value === "not_select"){
                    ...
                    /* display error message */
                    Shared.displayErrorMessages(inputField, divStatus, this.data.department_status.text.status);
                    /* update flag */
                    this.valid = false;
                }
                else {
    ...
    /* department create date field */
    departmentCreateDateFieldValidate(fieldName){
        /* get input element and div ids */
        let inputField = this.form.elements.namedItem(fieldName);
        let divBlank = document.getElementById(this.data.department_create_date.div_id.blank);
        let divBefore = document.getElementById(this.data.department_create_date.div_id.before);

        /* validate on-time blank fields */
        Shared.validateInputBlankFields(inputField, divBlank, this.data.department_create_date.text.blank, this);
        ...
        if(this.valid){
            ...
            inputField.addEventListener("input", () => {
                ...
                if(dates.create < dates.current){
                    ...
                    /* display error message */
                    Shared.displayErrorMessages(inputField, divBefore, this.data.department_create_date.text.before);
                    /* update flag */
                    this.valid = false;
                }
                else {
